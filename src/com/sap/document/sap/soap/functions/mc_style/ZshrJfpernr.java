...
@XmlType(name = "ZshrJfpernr", propOrder = { "pernr", "nachn", "orgeh", "orgtx", "zopath", "stat2", "text1", "werks", "name1", "plans", "plstx", "ictyp", "ictxt",
		"icnum", "email", "zmtel", "zotel", "emsid", "scrzd", "sclzd", "zxrzd", "zxlzt", "zgznx" })
public class ZshrJfpernr {
	...
	public String toString() {
		return "ZshrJfpernr [pernr=" + pernr + ", nachn=" + nachn + ", orgeh=" + orgeh + ", orgtx=" + orgtx + ", zopath=" + zopath + ", stat2=" + stat2 + ", text1="
				+ text1 + ", werks=" + werks + ", name1=" + name1 + ", plans=" + plans + ", plstx=" + plstx + ", ictyp=" + ictyp + ", ictxt=" + ictxt + ", icnum=" + icnum
				+ ", email=" + email + ", zmtel=" + zmtel + ", zotel=" + zotel + ", emsid=" + emsid + ", scrzd=" + scrzd + ", sclzd=" + sclzd + ", zxrzd=" + zxrzd
				+ ", zxlzt=" + zxlzt + ", zgznx=" + zgznx + "]";
	}

	public static String showTitle() {
		String s = "pernr\t" + "nachn\t" + "orgeh\t" + "orgtx\t" + "zopath\t" + "stat2\t" + "text1\t" + "werks\t" + "name1\t" + "plans\t" + "plstx\t" + "ictyp\t"
				+ "ictxt\t" + "icnum\t" + "email\t" + "zmtel\t" + "zotel\t" + "emsid\t" + "scrzd\t" + "sclzd\t" + "zxrzd\t" + "zxlzt\t" + "zgznx\t";
		return s;
	}
